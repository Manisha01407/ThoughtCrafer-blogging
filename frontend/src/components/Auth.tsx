import { SignupInput } from "@manisha1414/blogging-module";
        ...
        <div className="w-1/2">
          ...
          <div className="mt-2 pt-2 flex flex-col">
            ...
            <LabelledInput
              ...
              onChange={(e) => {
                setPostInputs({ ...postInputs, passowrd: e.target.value });
              }}
            />
            <button
              onClick={sendRequest}
            ...
            >
              <span className="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg ">
                ...
                <span className="absolute left-0 w-[28rem] h-96 -ml-2 transition-all duration-300 origin-top-right -rotate-90 -translate-x-full translate-y-12 bg-[#fff1f2] group-hover:-rotate-180 ease"></span>
